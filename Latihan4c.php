...
$Negara = [
    ["Indonesia : D.K.I. Jakarta","Singapura : Singapura","Malaysia : Kuala Lumpur","Brunei : Bandar Seri Begawan","Thailand : Bangkok","Laos : Vientiane","Filipina : Manila","Myanmar : Naypyidaw"]
];
?>
<!DOCTYPE html>
<html>
